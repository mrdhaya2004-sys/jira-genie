  	...
  	extend: {
  		...
  		colors: {
  			...
  			status: {
  				...
  				task: 'hsl(var(--status-task))',
  				story: 'hsl(var(--status-story))',
  		...
  		keyframes: {
			...
			'glow-pulse': {
				'0%, 100%': {
					boxShadow: '0 0 0 0 hsl(var(--glow-primary)), 0 0 18px -2px hsl(var(--glow-primary))'
				},
				'50%': {
					boxShadow: '0 0 0 6px hsl(var(--primary) / 0), 0 0 28px 2px hsl(var(--glow-primary))'
				}
			},
			float: {
		...
		animation: {
			...
			'fade-in-page': 'fade-in-page 0.25s ease-out',
  		...
  		boxShadow: {
  			...
  			'soft-lg': '0 4px 12px -4px rgba(0, 0, 0, 0.15), 0 8px 24px -8px rgba(0, 0, 0, 0.15)',
